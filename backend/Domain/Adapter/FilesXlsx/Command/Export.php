...
namespace Domain\Adapter\FilesXlsx\Command;
...
class Export extends Command 
{
	...
	static public function buildFromRequestData(array $requestData) 
	{
		...
		} elseif ($requestData['attributes']['filetype'] == 'xlsx') {

			$validationErrors['attributes']['adapter'] = 'validationErrors.attributes.adapter.missingAdapter';
		}

		if ($requestData['attributes']['filetype'] == 'docx' && empty($requestData['attributes']['imageurl'])) {

			$validationErrors['attributes']['imageurl'] = 'validationErrors.attributes.imageurl.emptyImageUrl';
		}

		if ($requestData['attributes']['filetype'] == 'xlsx' && empty($requestData['attributes']['identity'])) {

			$validationErrors['attributes']['adapter'] = 'validationErrors.attributes.adapter.missingIdentity';
		}
